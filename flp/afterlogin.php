    ...
    <table align="center"  width="90%" cellspacing="0" border="1" cellpadding="0" > 
			<tr>
				...
				<td align="center" colspan="2">
					<select onchange="la(this.value)">
						...
						<option value="policypage.php">Conditions</option>
						<option value="storesinfo.php">Stores info</option>
						<option value="uploadpage.php">UPLOAD</option>
						<option value="cartpage.php">CART</option>
						<option value="customerinfo.php">customerinfo</option>
					</select>|
			...
			<tr height="200px" >
				...
				<td colspan="4" height="150px" align="center" valign="top">
					<h2><font color="red">WELCOM TO HUMMINGBIRD WORLD....<font> SHUCHI<img src="picture1/shuchi.jpg" alt="" width="50px" height="50px"></h2>
